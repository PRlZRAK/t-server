<?php
$config['smtp_username'] = 'robot@tuktuk.su';  //Смените на адрес своего почтового ящика.
$config['smtp_port'] = '25'; // Порт работы.
$config['smtp_host'] =  'smtp.email.eu-frankfurt-1.oci.oraclecloud.com';  //сервер для отправки почты
$config['smtp_password'] = 'BdAg<-aKV3(S1BS3oBLE';  //Измените пароль
...
smtpmail('yaa', 'yaa52@mail.ru', 'Тема письма', 'HTML или обычный текст письма');
?>
